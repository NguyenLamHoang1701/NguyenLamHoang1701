...
void HTTP_handleRoot(void) {
  ...
  html += "<button onmousedown='startCommand(\"I\")' onmouseup='stopCommand()' ontouchstart='startCommand(\"I\")' ontouchend='stopCommand()'>Ahead Right</button>";
  html += "<button onmousedown='startCommand(\"G\")' onmouseup='stopCommand()' ontouchstart='startCommand(\"G\")' ontouchend='stopCommand()'>Ahead Left</button>";
  html += "<button onmousedown='startCommand(\"J\")' onmouseup='stopCommand()' ontouchstart='startCommand(\"J\")' ontouchend='stopCommand()'>Back Right</button>";
  html += "<button onmousedown='startCommand(\"H\")' onmouseup='stopCommand()' ontouchstart='startCommand(\"H\")' ontouchend='stopCommand()'>Back Left</button>";
